...
WRook::WRook(IDirect3DDevice9* pd3dDevice) : White(pd3dDevice)
{
	m_sMeshFN = "Models\\chess3D\\Wrook.x";
...
/*void WRook::AssignParameters(D3DLIGHT9& light1, D3DLIGHT9& light2, D3DXVECTOR3& eye, D3DMATRIX& view, D3DMATRIX& proj)
{
	SetLight1(&light1);
	SetLight2(&light2);
	m_mView = view;
