...
#include "White.h"
//int WBishop::m_iaMovementIndex[5] = { 17, 15, -17, -15, 0 };

WBishop::WBishop(IDirect3DDevice9* pd3dDevice) : White(pd3dDevice)
{
	m_sMeshFN = "Models\\chess3d\\WBishop.X";
...
/*void WBishop::AssignParameters(D3DLIGHT9& light1, D3DLIGHT9& light2, D3DXVECTOR3& eye, D3DMATRIX& view, D3DMATRIX& proj)
{
	SetLight1(&light1);
	SetLight2(&light2);
	m_mView = view;
